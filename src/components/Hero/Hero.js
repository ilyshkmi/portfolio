...
const Hero = (props) => (
  <Section row nopadding>
    <LeftSection>
      ...
      <SectionText>
        Hello, Ilyas Hakimi here. Experienced IT Officer at Nissha Precision Technologies Malaysia Sdn. Bhd. Expertise in managing and maintaining IT infrastructure, providing technical support, and implementing security measures. Adept at troubleshooting, network management, and IT projects. Committed to ensuring optimal system performance and data security.
